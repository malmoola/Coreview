...
await p.addInitScript(() => {
  localStorage.setItem("livetopo.projects.v1", JSON.stringify({perf:{
...
console.log("LS after load:", await p.evaluate(()=>Object.keys(JSON.parse(localStorage.getItem("livetopo.projects.v1")||"{}"))));
